...
/* package BaseMachineCompiler-0.1.0.0 */
#ifndef VERSION_BaseMachineCompiler
#define VERSION_BaseMachineCompiler "0.1.0.0"
#endif /* VERSION_BaseMachineCompiler */
#ifndef MIN_VERSION_BaseMachineCompiler
#define MIN_VERSION_BaseMachineCompiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BaseMachineCompiler */
...
#define CURRENT_COMPONENT_ID "BaseMachineCompiler-0.1.0.0-38AodinCA37ENqjAFj0L1P-BaseMachineCompiler"
